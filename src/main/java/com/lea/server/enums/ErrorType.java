...
public enum ErrorType {
    ...
    INVALID_FIELD(627, "Invalid field", false),
    INVALID_PRICE(633, "Invalid price", false),
    ...
    CATEGORY_DOES_NOT_EXIST(631,"category doesn't exist",false),
    INVALID_EMAIL(632,"invalid email" ,false );
